...
import cat.gencat.agaur.hexastock.marketdata.application.port.in.GetStockPriceUseCase;
 ...
 *   <li>Uses a secondary port ({@link MarketDataPort}) to communicate with driven adapters</li>
 * </ul>
 * </p>
 * 
 * <p>This service acts as a simple mediator between the primary and secondary ports,
 * delegating the actual price retrieval to the injected {@link MarketDataPort} implementation.</p>
 * 
...
public class GetStockPriceService implements GetStockPriceUseCase {
     ...
     */
    public GetStockPriceService(MarketDataPort stockPriceProviderPort) {
     ...
     * 
     * <p>This method delegates to the injected {@link MarketDataPort} to fetch
