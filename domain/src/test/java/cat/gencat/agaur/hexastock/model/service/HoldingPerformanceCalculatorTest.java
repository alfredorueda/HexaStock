 ...
 * its inputs in memory and asserts against the returned {@link HoldingPerformance}
...
class HoldingPerformanceCalculatorTest {
    ...
    /** Finds a HoldingPerformance by ticker in the result list (order-independent). */
    private static HoldingPerformance findByTicker(List<HoldingPerformance> results, String ticker) {
