...
PPTX="${OUTPUT_DIR}/defensa-trajectoria-10-minuts.pptx"
PRESENTATION_PDF="${OUTPUT_DIR}/defensa-trajectoria-10-minuts_Alfredo_Rueda.pdf"

ORAL_MD="${OUTPUT_DIR}/materials-orals-canonics-10-minuts-trajectoria.md"
ORAL_DOCX="${OUTPUT_DIR}/materials-orals-canonics-10-minuts-trajectoria.docx"
ORAL_PDF="${OUTPUT_DIR}/guio-oral-complet-imprimible-trajectoria-10-minuts.pdf"

REMARKABLE_DOCX="${OUTPUT_DIR}/REMARKABLE_materials-orals-canonics-10-minuts-trajectoria.docx"
REMARKABLE_PDF="${OUTPUT_DIR}/REMARKABLE_materials-orals-canonics-10-minuts-trajectoria.pdf"
REMARKABLE_MIN_FONT_PT="${REMARKABLE_MIN_FONT_PT:-18}"

NORMAL_REFERENCE_DOCX_SOURCE="${OUTPUT_DIR}/materials-orals-canonics-20-minuts.docx"
REMARKABLE_REFERENCE_DOCX_SOURCE="${OUTPUT_DIR}/REMARKABLE_materials-orals-canonics-20-minuts.docx"
...
require_file "${NORMAL_REFERENCE_DOCX_SOURCE}"
require_file "${REMARKABLE_REFERENCE_DOCX_SOURCE}"
...
cp "${NORMAL_REFERENCE_DOCX_SOURCE}" "${NORMAL_REFERENCE_DOCX}"
cp "${REMARKABLE_REFERENCE_DOCX_SOURCE}" "${REMARKABLE_REFERENCE_DOCX}"

echo "Generant DOCX del guió oral de trajectòria..."
pandoc "${ORAL_MD}" \
  --standalone \
...
echo
echo "Materials derivats de trajectòria generats:"
echo "- ${ORAL_DOCX}"
echo "- ${ORAL_PDF}"
