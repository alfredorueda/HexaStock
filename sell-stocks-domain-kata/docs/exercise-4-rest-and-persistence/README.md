...
> it can be reviewed and argued with before any code exists — extending the specification and
> reusable-workflow habits developed in Exercises 2 and 3.

## The goal

Take the domain from Exercise 2's
[`reference-solution/`](../exercise-2-specification-driven/reference-solution/) **unchanged** and
put a real application around it: Spring Boot,
...
Two things written down in Exercise 2 are currently only documentation. Exercise 4 turns both
...
defines the three tables and runs on SQLite and PostgreSQL. Exercise 4 decides whether JPA
